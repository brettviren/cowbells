...
class WCSim_Draw : public TGMainFrame {
...
/*    Int_t particle_vertex[3]; */
 ...
 public:
   ...
   WCSim_Draw(TString filename, const TGWindow *p, UInt_t w, UInt_t h);
   ...
   void SetTiming_lcut(Float_t a){ltiming_cut = a;};
   void SetTiming_hcut(Float_t a){htiming_cut = a;};
