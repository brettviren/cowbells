...
\begin{frame}[fragile]
  ...
  \includegraphics[width=0.45\textwidth]{magic_plots/water_475mev_dedx_total.pdf}%
  \includegraphics[width=0.45\textwidth]{magic_plots/water_2gev_dedx_total.pdf}

  \includegraphics[width=0.45\textwidth]{magic_plots/wbls01_475mev_dedx_total.pdf}%
  \includegraphics[width=0.45\textwidth]{magic_plots/wbls01_2gev_dedx_total.pdf}
\end{frame}
