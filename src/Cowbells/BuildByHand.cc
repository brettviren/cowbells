...
namespace Cfg {
    ...
    std::string sample_material1 = "WBLS";
    std::string tub_material1 = "Teflon";
    //std::string sample_material2 = "Water";
    std::string sample_material2 = "WBLS";
...
void Cowbells::BuildByHand::MakeMaterials()
{
                                                   ...
                                                   std::string mat_tub_name)
{
    ...
    { // place window in lid
        ...
        double offset = 0.5*Cfg::sample_height - sample_offset - 0.034;
...
G4VPhysicalVolume* Cowbells::BuildByHand::ConstructGeometry()
{
    this->MakeMaterials();
