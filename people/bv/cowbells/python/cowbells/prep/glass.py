...
def materials(geo):
    util.make_mixture(geo, 'SiO2', [("Silicon",1),('Oxygen',2)],  2.20*gram/cm3)
    util.make_mixture(geo, 'B2O3', [("Boron",2),('Oxygen',3)],    2.46*gram/cm3)
    util.make_mixture(geo, 'Na2O', [("Sodium",2),('Oxygen',1)],   2.27*gram/cm3)
    util.make_mixture(geo, 'Al2O3',[("Aluminium",2),('Oxygen',3)], 4.00*gram/cm3)
